...
def create_mask(image_path, location = 'normal'):
    pic_path = image_path
    ...
    show = False
    model = "hog"
    FaceMasker(pic_path, mask_path, show, model, location).mask()
...
class FaceMasker:
    ...
    def __init__(self, face_path, mask_path, show=False, model='hog', location='normal'):
